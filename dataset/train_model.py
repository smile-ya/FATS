...
def main(args):
    ...
    :return:
    """
    assert args.dataset in ['mnist', 'cifar10', 'svhn', 'cifar100', 'fashion_mnist', 'all'], \
        "dataset parameter must be either 'mnist', 'cifar10', 'svhn', 'cifar100', 'fashion_mnist', 'all'"
    if args.dataset == 'all':
        for dataset in ['mnist', 'cifar10', 'svhn', 'cifar100', 'fashion_mnist']:
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        '-d', '--dataset',
        help="Dataset to use; either 'mnist', 'cifar10', 'svhn','cifar100','fashion_mnist' or 'all'",
